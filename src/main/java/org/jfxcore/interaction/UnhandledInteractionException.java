...
/**
 * Thrown when an interaction request was not handled.
 *
...
public class UnhandledInteractionException extends RuntimeException {
    ...
    /**
     * Creates a new instance of {@code UnhandledInteractionException}.
     *
     * @param message the message
     * @param request the interaction request
     */
    public UnhandledInteractionException(String message, InteractionRequest<?, ?> request) {
        super(message);
